                                            ...
                                            <div class="col-xl-5 col-lg-5 col-md-6 col-sm-8">
                                                <div id="formBox" class="">
                                                    ...
                                                    <div class="text-center">
                                                        <button class="custom-btn mt-3" id="track" type="button" onclick="trackShipment()">
                                                            Track Shipment
...
const trackShipment = async () => {
    let clickedBtn = document.querySelector("#track");
    ...
    return await axios.get(`${baseUrl}/shipping/${shippingId}/track`, config)
    .then((res) => {
        
        setBtnNotLoading(clickedBtn, oldHtml);
    ...
    .catch((err) => {
        setBtnNotLoading(clickedBtn, oldHtml);
        showAlert('danger', err?.response?.data.error.split(":")[5].slice(0, -7));
