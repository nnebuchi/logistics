<div id="shipping" style="display:none;">
    <div class="py-2 mt-2" style="background-color:#E9EFFD;border-radius:10px;">
    ...
    <div class="text-center pt-4 mt-2" style="height:130px;background-color:#FCE4C2F7;border-radius:10px;">
        ...
        <div>
            <button type="button" class="btn bg-white px-4">
        ...
        <div class="row justify-content-center">
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-9 mt-sm-2">
                ...
                <div class="w-100 mt-2">
                    ...
                    <input type="text" name="" placeholder="" class="custom-input" />
                    <span class="error"> </span>
                </div>
            </div>
